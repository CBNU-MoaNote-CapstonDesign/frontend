...
export default function InviteUserModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 w-[480px] max-w-[90vw] flex flex-col gap-6 animate-in fade-in-0 zoom-in-95 duration-200 mt-24">
        {/* 헤더 */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-800">사용자 초대</h2>
